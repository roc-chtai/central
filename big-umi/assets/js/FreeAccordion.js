...
(function (global) {
  ...
  function insertTableFlex(entry, admin, colCount=2){
    ...
    // ✅ 用 ts-table，讓 Table.css 一套吃 FreeAccordion + FreeTable
    table.className = 'table table-bordered align-middle small mb-0 ts-table';
